...
const DropdownMenuItem = ({
  ...
  <DropdownMenuPrimitive.Item
    className={cn(
      'outline-hidden focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm transition-colors [&>svg]:size-4 [&>svg]:shrink-0',
      inset && 'pl-8',
